...
``name`` :
  Name that will be used across SearXNG-SE to define this engine.  In settings, on
  the result page...
...
``timeout`` : optional
  ...
  modify the global timeout of SearXNG-SE.**
...
SearXNG-SE does not support true multilingual search.  You have to use the language
...
language, SearXNG-SE will search in your default and other language.
